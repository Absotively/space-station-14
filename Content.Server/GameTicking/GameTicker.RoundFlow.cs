...
namespace Content.Server.GameTicking
{
    public sealed partial class GameTicker
    {
        ...
        public void StartRound(bool force = false)
        {
            ...
            var readyPlayerPreferences = new Dictionary<NetUserId, PlayerPreferences>();
            ...
            foreach (var (userId, status) in _playerGameStatuses)
            {
                ...
                {
                    readyPlayerPreferences.Add(userId, preferences);
                }
                else
                {
                    var prefs = new PlayerPreferences(
                        ...
                        0, Color.Transparent);
                    readyPlayerPreferences.Add(userId, prefs);
                }
            }
            ...
            SpawnPlayers(readyPlayers, readyPlayerPreferences, force);
