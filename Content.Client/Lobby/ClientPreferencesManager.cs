...
namespace Content.Client.Lobby
{
    ...
    public sealed class ClientPreferencesManager : IClientPreferencesManager
    {
        ...
        public void Initialize()
        {
            ...
            _netManager.RegisterNetMessage<MsgUpdateRolePreferences>();
        ...
        {
            Preferences = new PlayerPreferences(Preferences.Characters, slot, Preferences.AdminOOCColor, Preferences.RolePreferences);
        ...
        public void UpdateCharacter(ICharacterProfile profile, int slot)
        {
            ...
            Preferences = new PlayerPreferences(characters, Preferences.SelectedCharacterIndex, Preferences.AdminOOCColor, Preferences.RolePreferences);
        ...
        public void UpdateRolePreferences(IRolePreferences rolePreferences)
        {
            var collection = IoCManager.Instance!;
            rolePreferences.EnsureValid(collection);
            Preferences = new PlayerPreferences(Preferences.Characters, Preferences.SelectedCharacterIndex, Preferences.AdminOOCColor, rolePreferences);
            var msg = new MsgUpdateRolePreferences
            {
