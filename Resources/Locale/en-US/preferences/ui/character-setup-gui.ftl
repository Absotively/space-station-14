...
character-setup-gui-highest-priority-job-label = Highest priority job
character-setup-gui-highest-priority-job-unset-option = (unset)
...
character-setup-gui-character-picker-button-round-start-button-inactive = Inactive
character-setup-gui-character-picker-button-round-start-button-active = Active
